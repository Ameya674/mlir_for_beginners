...
```
**llvm_project/mlir/examples/toy/ChX -** Contains the source code for the compiler. Each chapter adds new files to the compiler, culminating with a full compiler in the end.

**llvm_project/build/bin/toyc-chx -** Compiled version of the compiler for the given chapter. 

**llvm_project/mlir/test/Examples/Toy/ChX -** Contains the toy language code for testing. 

**llvm_project/build/bin/mlir-tblgen -** Generates C++ include files from the tablegen code. 

**llvm_project/build/tools/examples/toy/ChX/include/toy/ -** This folder contains all the include files generated by the mlir-tblgen command. 
